...
using ShopDienTu.Application.System.Roles;
using ShopDienTu.Application.System.Users;
...
namespace ShopDienTu.BackendApi
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<ShopDienTuDbContext>(options =>
        options.UseSqlServer(Configuration.GetConnectionString(SystemConstants.MainConnectionString)));
            services.AddIdentity<AppUser, AppRole>()
                .AddEntityFrameworkStores<ShopDienTuDbContext>()
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "My Shop Dien Tu V1");
            });
